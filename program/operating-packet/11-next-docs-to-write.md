...
2. ~~`v0.1-boundary-and-non-goals.md`~~ — **Written:** [`architecture/current/v0.1-boundary-and-non-goals.md`](../../architecture/current/v0.1-boundary-and-non-goals.md)
3. ~~`v1.0-parcel-kit-architecture.md`~~ — **Written:** [`architecture/current/v1.0-parcel-kit-architecture.md`](../../architecture/current/v1.0-parcel-kit-architecture.md)
