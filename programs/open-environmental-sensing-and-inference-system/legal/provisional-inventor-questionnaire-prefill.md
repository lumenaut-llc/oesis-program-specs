...
10. Where is the earliest written record?
   ...
   - likely candidates:
     - `repo/programs/open-environmental-sensing-and-inference-system/docs/data-model/parcel-state-schema.md`
     - `repo/programs/open-environmental-sensing-and-inference-system/software/inference-engine/architecture.md`
