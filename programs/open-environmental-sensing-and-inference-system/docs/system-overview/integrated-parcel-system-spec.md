...
- `repo/oesis/` is the canonical Python implementation tree for the current reference services.
- `programs/open-environmental-sensing-and-inference-system/software/*/scripts/*.py` remains in place as a compatibility layer for docs, smoke checks, and operator-facing commands.
...
- Use `repo/oesis/` as the canonical Python implementation tree.
- Keep `programs/open-environmental-sensing-and-inference-system/software/*/scripts/` as compatibility entrypoints only.
