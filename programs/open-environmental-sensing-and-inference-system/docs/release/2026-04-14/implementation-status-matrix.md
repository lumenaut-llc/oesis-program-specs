...
| Surface | Status | Evidence | Current boundary | Next gap |
| --- | --- | --- | --- | --- |
| Public preview site scaffold | implemented | `sites/public-preview/` plus `docs/release/2026-04-14/site/public-content-allowlist.md` | Stable Astro app is separated from release-owned publication controls. | Keep the app, release packet, and publication gate aligned. |
