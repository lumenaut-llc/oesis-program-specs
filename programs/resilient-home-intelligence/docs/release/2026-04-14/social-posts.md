...
Today we’re publicly sharing the April 14 open release for Resilient Home
...
We’re sharing the April 14 open release for Resilient Home Intelligence: a
homeowner-owned, parcel-first environmental sensing project. Private by default.
Shared by choice. Start with the governance and release framework here: [link]
...
Resilient Home Intelligence is a homeowner-centered environmental sensing effort
focused on parcel-level situational awareness for smoke, flooding/runoff, and heat.
The project is designed around homeowner ownership of raw data, opt-in sharing,
explicit uncertainty, and a commons-protective open-release posture across software,
hardware, documentation, and intentionally public artifacts.
...
- packet formats
- anything implying certified safety guidance
