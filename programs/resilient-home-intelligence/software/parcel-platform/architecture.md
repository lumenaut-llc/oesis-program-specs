...
It is also the primary surface for showing sharing choices, consent state, and homeowner rights controls without blurring private parcel data, shared data, public context, and derived estimates.
...
- homeowner-facing parcel condition-estimate view
...
- Sharing setting changes and revocations should take effect quickly and be visible to the homeowner without ambiguity.
