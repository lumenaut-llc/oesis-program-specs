...
The smallest practical indoor air-sensing node for validating the Resilient Home Intelligence stack end to end. It is a USB-powered ESP32-S3 build with temperature, humidity, pressure, and VOC trend sensing intended for desk, garage, or sheltered porch use.
