...
#include <WiFi.h>
#define MAST_LITE_HAS_WIFI 1
#else
#define MAST_LITE_HAS_WIFI 0
#endif
...
#ifndef MAST_LITE_WIFI_SSID
#define MAST_LITE_WIFI_SSID ""
#endif

#ifndef MAST_LITE_WIFI_PASSWORD
#define MAST_LITE_WIFI_PASSWORD ""
#endif

static const char* kSchemaVersion = "rhi.bench-air.v1";
static const char* kNodeId = "mast-lite-01";
static const char* kFirmwareVersion = "0.1.0";
static const char* kLocationMode = "sheltered";
static const char* kObservedAtPlaceholder = "1970-01-01T00:00:00Z";
static const char* kWifiSsid = MAST_LITE_WIFI_SSID;
static const char* kWifiPassword = MAST_LITE_WIFI_PASSWORD;
...
void emitPacket(const Sht45Reading& sht45, const Bme680Reading& bme680_reading) {
  ...
  Serial.print(bme680_reading.present ? "true" : "false");
  Serial.print(",\"temperature_c\":");
  printFloat(bme680_reading.temperature_c);
  Serial.print(",\"relative_humidity_pct\":");
  printFloat(bme680_reading.relative_humidity_pct);
...
void setup() {
  ...
  Serial.println("# mast_lite_serial_json");
  ...
  } else if (last_error != "sht45_init_failed") {
    last_error = "";
  }
}
...
void loop() {
  ...
  updateObservedAt();
  if (!sht45.present || !bme680_reading.present) {
    read_failures_total++;
