...
Define the stewardship, decision-making, and change-control model for the Resilient Home Intelligence project during the April 14, 2026 preview phase and the transition to broader open release.

This file is a project governance draft, not legal advice.

## Mission

Resilient Home Intelligence exists to build a modular, homeowner-centered environmental sensing and parcel-awareness system that:
