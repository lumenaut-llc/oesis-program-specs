...
The candidate invention sits inside the broader Resilient Home Intelligence system, which includes hardware sensor nodes, an ingest service, an inference engine, a parcel platform, and shared neighborhood views. For purposes of this draft, the focus is the parcel-state generation method performed after ingest normalization and before homeowner presentation.
