...
10. Where is the earliest written record?
   ...
   - likely candidates:
     - `repo/programs/resilient-home-intelligence/docs/data-model/parcel-state-schema.md`
     - `repo/programs/resilient-home-intelligence/software/inference-engine/architecture.md`
