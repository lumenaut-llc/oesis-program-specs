# Consent Store Schema (`v1.0`)

## Purpose

Define the append-only consent lifecycle store used by reference services to
enforce active sharing eligibility at query time.
...
`v1.0` elevates this store from policy documentation to query-enforced
governance state in reference runtime paths.
