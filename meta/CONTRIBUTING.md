...
- do not add new runtime dependencies on `contracts/`, `architecture/`, `release/`, `hardware/`, `software/`, `legal/`, `operations/`, `media/`, `shared/`, `meta/`, or `sites/`
...
- update any affected subsystem, system, contract, release, legal, or operations docs in their owned directories
- update `architecture/` when the current or target architecture version changes
...
- `hardware(calibration): add rain gauge test procedure`
