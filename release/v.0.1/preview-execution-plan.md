...
- canonical package path remains sibling repo `../oesis-runtime`

### Next concrete steps

1. Keep `make oesis-validate`, `make oesis-check`, and `make oesis-http-check` green before any release or pilot demo.
...
2. Use [`parcel-kit/parcel-kit-procurement-checklist.md`](https://github.com/lumenaut-llc/oesis-hardware/blob/main/v0.1/parcel-kit/parcel-kit-procurement-checklist.md) as the explicit purchase gate for Tier 1 and Tier 2 builds.
3. Use [`parcel-kit/parcel-installation-checklist.md`](https://github.com/lumenaut-llc/oesis-hardware/blob/main/v0.1/parcel-kit/parcel-installation-checklist.md) for:
...
- `../../operations/pilots/pilot-operator-checklist.md`
- `../../operations/pilots/pilot-participant-notice.md`
- `../../operations/pilots/pilot-incident-playbook.md`
