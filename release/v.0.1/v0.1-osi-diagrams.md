...
**Deployment posture** (per [`oesis-builds/specs/bench-air-node/v0-1.md`](https://github.com/lumenaut-llc/oesis-builds/blob/main/specs/bench-air-node/v0-1.md) §F block and [`../../architecture/system/deployment-maturity-ladder.md`](../../architecture/system/deployment-maturity-ladder.md) indoor-class row):
...
**Deployment posture** (per [`oesis-builds/specs/flood-node/v0-1.md`](https://github.com/lumenaut-llc/oesis-builds/blob/main/specs/flood-node/v0-1.md) §F block and [`deployment-maturity-ladder.md`](../../architecture/system/deployment-maturity-ladder.md) outdoor-class row):
...
**Deployment posture** (per [`oesis-builds/specs/weather-pm-mast/v0-1.md`](https://github.com/lumenaut-llc/oesis-builds/blob/main/specs/weather-pm-mast/v0-1.md) §F block pattern and [`deployment-maturity-ladder.md`](../../architecture/system/deployment-maturity-ladder.md) outdoor-class row):
...
**Deployment posture** (per [`oesis-builds/specs/adapters/circuit-monitor/v0-1.md`](https://github.com/lumenaut-llc/oesis-builds/blob/main/specs/adapters/circuit-monitor/v0-1.md) §F block — **adapter** (adapter-trust-program §F) with physical_posture declared):
