# Parcel Platform Interfaces v1.0

## Purpose

Describe the target-lane parcel-facing APIs once the bridge-stage support
surfaces are treated as first-class product objects.
...
- `house_state`
- `house_capability` as coarse, read-side capability hints
- `interventions`
- `verification_outcomes`

## Controls note

`control_compatibility` may exist in draft form in the target lane, but it
should not be treated as the main near-term product surface.
