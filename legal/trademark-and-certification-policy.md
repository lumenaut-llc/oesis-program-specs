...
Define how the project's name, marks, compatibility language, and any future certification claims may be used without misleading users about safety, provenance, or official status.

## Governing rule

Open-source licensing of code and hardware does not grant an automatic right to use the project's marks in a way that implies official endorsement, safety validation, or interoperability certification.
...
- endorsement by the maintainers
...
- sponsorship or endorsement by the project maintainers
...
No certification mark should imply a life-safety warranty unless the project has the evidence, governance, and legal basis to support that claim.
