# Open Source DIY Tech — Resilient Home Intelligence

This repository is the first-pass scaffold for the Resilient Home Intelligence program inside Open Source DIY Tech.
...
- `programs/resilient-home-intelligence/` — the main program
- `shared/` — shared standards, templates, and glossary
- `meta/` — planning, milestones, and operating notes
