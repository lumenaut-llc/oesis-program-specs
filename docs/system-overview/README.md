...
- `../../technical-architecture/README.md` is the sibling versioned technical architecture canon.
- `../../technical-architecture/v0.1/README.md` is the current truthful reference-architecture slice.
- `../../technical-architecture/v1.0/README.md` is the debated target-architecture slice.
