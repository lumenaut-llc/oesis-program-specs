...
Hardware specifications, build guides, firmware, and BOMs have moved to
[**oesis-hardware**](https://github.com/lumenaut-llc/oesis-hardware).

This directory retains only the `LICENSE` file (CERN-OHL-S-2.0) as a reference
for the split-license model described in [`LICENSES.md`](../LICENSES.md).
